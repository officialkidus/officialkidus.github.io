...
!(function(a, b) {
  ...
  var t = (function(a) {
    ...
    function qb() {}
    (qb.prototype = d.filters =
      d.pseudos), (d.setFilters = new qb()), (g = gb.tokenize = function(a, b) {
      var c,
        e,
        f,
        g,
  ...
  (n.filter = function(a, b, c) {
    ...
    find: function(a) {
      ...
      return (d = this.pushStack(c > 1 ? n.unique(d) : d)), (d.selector = this
        .selector
        ? this.selector + " " + a
        : a), d;
    },
  ...
  (n.event = {
    ...
    add: function(a, b, c, d, e) {
      ...
      if (r) {
        c.handler && ((f = c), (c = f.handler), (e = f.selector)), c.guid ||
          (c.guid = n.guid++), (i = r.events) || (i = r.events = {}), (g =
          r.handle) ||
        ...
        while (j--)
          if (
            ...
            (l = n.event.special[o] || {}), (o =
              (d ? l.delegateType : l.bindType) || o), (m = i[o] || []), (h =
              h[2] &&
              new RegExp(
                "(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"
              )), (g = f = m.length);
    ...
    trigger: function(b, c, d, e) {
      ...
      if (
        ...
        while ((g = p[f++]) && !b.isPropagationStopped())
          (b.type = f > 1 ? i : o.bindType || q), (m =
            (L.get(g, "events") || {})[b.type] && L.get(g, "handle")), m &&
            m.apply(g, c), (m = k && g[k]), m &&
            m.apply &&
            n.acceptData(g) &&
          ...
          while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped())
            (!a.namespace_re || a.namespace_re.test(g.namespace)) &&
              (
                (a.handleObj = g),
                (a.data = g.data),
                (e = ((n.event.special[g.origType] || {}).handle || g.handler)
                  .apply(f.elem, i)),
                void 0 !== e &&
                  (a.result = e) === !1 &&
    ...
    off: function(a, b, c) {
      ...
      return (b === !1 || "function" == typeof b) &&
        ((c = b), (b = void 0)), c === !1 && (c = $), this.each(function() {
  ...
  (ib.optgroup =
    ib.option), (ib.tbody = ib.tfoot = ib.colgroup = ib.caption = ib.thead), (ib.th = ib.td);
  function jb(a, b) {
  ...
  n.extend({
      ...
      for (
        ...
        if (((e = a[m]), e || 0 === e))
          if ("object" === n.type(e)) n.merge(l, e.nodeType ? [e] : e);
            ...
            (f = f || k.appendChild(b.createElement("div"))), (g = (bb.exec(
              e
            ) || ["", ""])[1]
              .toLowerCase()), (h = ib[g] || ib._default), (f.innerHTML =
    ...
    replaceWith: function() {
      ...
      return this.domManip(arguments, function(b) {
        (a = this
          .parentNode), n.cleanData(ob(this)), a && a.replaceChild(b, this);
  ...
  function tb(a) {
    ...
    return c ||
      (
        ...
        ("none" !== c && c) ||
          (
            (qb = (qb || n("<iframe frameborder='0' width='0' height='0'/>"))
  ...
  !(function() {
    ...
    if (f.style) {
      (f.style.backgroundClip = "content-box"), (f.cloneNode(
        ...
        "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute"), e.appendChild(
        f
      );
      function g() {
        (f.style.cssText =
          "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute"), (f.innerHTML =
          ""), d.appendChild(e);
        ...
        n.extend(k, {
          ...
          reliableMarginRight: function() {
            ...
            return (c.style.cssText = f.style.cssText =
              "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0"), (c.style.marginRight = c.style.width =
              "0"), (f.style.width = "1px"), d.appendChild(e), (b = !parseFloat(
  ...
  n.extend({
    ...
    style: function(a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        var e,
          ...
          h = n.camelCase(b),
          i = a.style;
        return (b = n.cssProps[h] || (n.cssProps[h] = Fb(i, h))), (g =
    ...
    css: function(a, b, c, d) {
      ...
      return (b = n.cssProps[h] || (n.cssProps[h] = Fb(a.style, h))), (g =
        ...
        "get" in g &&
        (e = g.get(a, !0, c)), void 0 === e && (e = xb(a, b, d)), "normal" ===
        e &&
        b in Db &&
        (e = Db[b]), "" === c || c
  ...
  (n.Tween = Kb), (Kb.prototype = {
    ...
    init: function(a, b, c, d, e, f) {
      (this.elem = a), (this.prop = c), (this.easing =
        e ||
        "swing"), (this.options = b), (this.start = this.now = this.cur()), (this.end = d), (this.unit =
        f || (n.cssNumber[c] ? "" : "px"));
    },
    cur: function() {
    ...
    run: function(a) {
      ...
      return (this.pos = b = this.options.duration
        ...
        : a), (this.now = (this.end - this.start) * b + this.start), this
        .options.step && this.options.step.call(this.elem, this.now, this), c &&
      c.set
        ? c.set(this)
  ...
  function Vb(a, b, c) {
    ...
    c.queue ||
      ...
      (
        ...
        l.always(function() {
          (o.overflow =
            c.overflow[0]), (o.overflowX = c.overflow[1]), (o.overflowY = c.overflow[2]);
        })
      );
    for (d in b)
      if (((e = b[d]), Nb.exec(e))) {
    ...
    if (n.isEmptyObject(m))
      ...
      q
        ...
        : (q = L.access(a, "fxshow", {})), f && (q.hidden = !p), p
        ? n(a).show()
        : l.done(function() {
            n(a).hide();
          }), l.done(function() {
  ...
  (n.Animation = n.extend(Xb, {
    ...
    return (a = n.fx ? n.fx.speeds[a] || a : a), (b =
    ...
    (a.type =
      "checkbox"), (k.checkOn = "" !== a.value), (k.optSelected = c.selected), (b.disabled = !0), (k.optDisabled = !c.disabled), (a = l.createElement("input")), (a.value = "t"), (a.type = "radio"), (k.radioValue = "t" === a.value);
  })();
  var Yb,
    Zb,
    $b = n.expr.attrHandle;
  ...
  a.attachEvent &&
    ...
    !!Ec &&
    "withCredentials" in Ec), (k.ajax = Ec = !!Ec), n.ajaxTransport(function(
    a
  ) {
    var b;
    return k.cors || (Ec && !a.crossDomain)
      ? {
          send: function(c, d) {
            ...
            }), (f.onload = b()), (f.onerror = b("error")), (b = Cc[g] = b(
              "abort"
            ));
            try {
  ...
  (n.fn.load = function(a, b, c) {
    ...
    var d,
      ...
      h = a.indexOf(" ");
    return h >= 0 &&
      ((d = n.trim(a.slice(h))), (a = a.slice(0, h))), n.isFunction(b)
      ? ((c = b), (b = void 0))
...
(function(t) {
  ...
  function o(o) {
    return o.bind(n, "DOMContentLoaded", i), o.bind(
      n,
      "readystatechange",
      i
    ), o.bind(t, "load", i), e;
  ...
  var n = t.document,
    r = [];
  (e.isReady = !1), "function" == typeof define && define.amd
    ? (
  ...
  (o.getListeners = function(t) {
    ...
    for (n in s)
      if (s.hasOwnProperty(n))
        for (o = s[n].length; o--; )
          (i = s[n][o]), i.once === !0 &&
            this.removeListener(t, i.listener), (r = i.listener.apply(
            this,
            e || []
  ...
  function o(t) {
    function o(t) {
      if (
        ...
        var b = e(o.height);
        return b !== !1 && (n.height = b + (z ? 0 : g + L)), (n.innerWidth =
          n.width - (m + I)), (n.innerHeight =
          n.height - (g + L)), (n.outerWidth = n.width + v), (n.outerHeight =
          n.height + _), n;
      }
    }
    function a(t, e) {
      ...
      var i = t.style,
        ...
        r = t.runtimeStyle,
        s = r && r.left;
      return s && (r.left = t.currentStyle.left), (i.left = e), (e =
        i.pixelLeft), (i.left = o), s && (r.left = s), e;
    }
    var u,
      p = t("boxSizing");
    return (function() {
      if (p) {
        ...
        (t.style.width = "200px"), (t.style.padding =
          "1px 2px 3px 4px"), (t.style.borderStyle =
          "solid"), (t.style.borderWidth = "1px 2px 3px 4px"), (t.style[p] =
          "border-box");
  ...
  function n(t, n, r) {
    ...
    e(a.prototype, t.prototype), (a.prototype._create = function() {
      ...
      (n -= i ? a.paddingLeft : a.paddingRight), (r -= o
        ? a.paddingTop
        : a.paddingBottom), (this.position.x = n), (this.position.y = r);
    ...
    (a.prototype._transitionTo = function(t, e) {
      ...
      (a = h.isOriginLeft ? a : -a), (u = h.isOriginTop
        ? u
        : -u), (p.transform = y(a, u)), this.transition({
        to: p,
      ...
      : a.prototype.goTo), (a.prototype.setPosition = function(t, e) {
  ...
  function s(i, s, f, d, l, y) {
    function m(t, i) {
      if (("string" == typeof t && (t = a.querySelector(t)), !t || !c(t)))
        return u &&
          u.error(
            "Bad " + this.constructor.namespace + " element: " + t
          ), void 0;
      ...
      var o = ++g;
      (this.element.outlayerGUID = o), (v[o] = this), this._create(), this
        .options.isInitLayout && this.layout();
    }
    var g = 0,
      v = {};
    return (m.namespace = "outlayer"), (m.Item = y), (m.defaults = {
      ...
      m.prototype.layout), (m.prototype._resetLayout = function() {
      this.getSize();
    ...
    }), (m.prototype._getContainerSize = h), (m.prototype._setContainerMeasure = function(
      t,
      e
    ) {
      if (void 0 !== t) {
    ...
    }), (m.prototype._manageStamp = h), (m.prototype._getElementOffset = function(
      t
    ) {
      ...
      this.unbindResize(), delete this.element.outlayerGUID, p &&
        p.removeData(this.element, this.constructor.namespace);
    }), (m.data = function(t) {
      ...
      return Object.create
        ...
        : e(
            o.prototype,
            m.prototype
          ), (o.prototype.constructor = o), (o.defaults = e({}, m.defaults)), e(
        o.defaults,
        i
      ), (o.prototype.settings = {}), (o.namespace = t), (o.data =
        m.data), (o.Item = function() {
  ...
  function e(t) {
    ...
    return (e.prototype = new t.Item()), (e.prototype._create = function() {
      (this.id = this.layout.itemGUID++), t.Item.prototype._create.call(
        this
      ), (this.sortData = {});
  ...
  function e(t, e) {
    ...
    return (function() {
      ...
      return (o.prototype = new i()), e &&
        (o.options = e), (o.prototype.namespace = t), (i.modes[t] = o), o;
    }), i;
  }
  "function" == typeof define && define.amd
    ? define(
  ...
  function e(t, e) {
    ...
    return (o.prototype._resetLayout = function() {
      ...
      (this.columnWidth += this.gutter), (this.cols = Math.floor(
  ...
  function i(t, i) {
    ...
    e(
      o.prototype,
      i.prototype
    ), (o.prototype._getElementOffset = n), (o.prototype.layout = r), (o.prototype._getMeasurement = s);
    ...
    return (o.prototype._manageStamp = function() {
      (this.options.isOriginLeft = this.isotope.options.isOriginLeft), (this.options.isOriginTop = this.isotope.options.isOriginTop), u.apply(
        this,
        arguments
      );
    }), o;
  ...
  function r(t, i, r, u, h) {
    ...
    (c.Item = u), (c.LayoutMode = h), (c.prototype._create = function() {
      (this.itemGUID = 0), (this._sorters = {}), this._getSorters(), t.prototype._create.call(
        this
      ...
      var i = h.modes[t],
        o = this.options[t] || {};
      (this.options[t] = i.options ? e(i.options, o) : o), (this.modes[
        t
      ] = new i(this));
      ...
      this.option(t), this._getIsInstant(), (this.filteredItems = this._filter(
        this.items
      )), this._sort(), this._layout();
    }), (c.prototype._init =
      c.prototype.arrange), (c.prototype._getIsInstant = function() {
      var t =
        void 0 !== this.options.isLayoutInstant
          ? this.options.isLayoutInstant
          : !this._isLayoutInited;
    ...
    (c.sortDataParsers = {
      ...
      if (t) {
        ...
        this.filteredItems.sort(i), t !== this.sortHistory[0] &&
      ...
      if (e.length) {
        ...
        this.layoutItems(i), (this.filteredItems = o.concat(
          this.filteredItems
        ));
      }
